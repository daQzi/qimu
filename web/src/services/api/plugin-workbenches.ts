...
export type WorkbenchPreview = { input: Record<string, unknown>; prompts: string[]; conflicts: Array<{ field: string; message: string }>; selection: WorkbenchSelection; valid: boolean; validationMessage?: string };
