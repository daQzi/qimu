...
export type PluginResultView = { id: string; component: "key-value/v1" | "table/v1" | "entity-cards/v1" | "mapping-editor/v1" | "media-compare/v1" | "video-report-editor/v1" | "video-plan-editor/v1"; collectionPath?: string; fields: { path: string; label: string }[] };
