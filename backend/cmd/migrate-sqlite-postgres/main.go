...
func migrations() []tableMigration {
	return []tableMigration{
		...
		migrateTable[model.PluginNamespace]("plugin_namespaces"),
		migrateTable[model.PluginApplication]("plugin_applications"),
		migrateTable[model.PluginRelease]("plugin_releases"),
		migrateTable[model.PluginReleaseDependency]("plugin_release_dependencies"),
		migrateTable[model.PluginSkillBinding]("plugin_skill_bindings"),
		migrateTable[model.PluginCatalogLock]("plugin_catalog_locks"),
		...
		migrateTable[model.PluginRun]("plugin_runs"),
		migrateTable[model.PluginRunStep]("plugin_run_steps"),
		migrateTable[model.PluginRunEvent]("plugin_run_events"),
		migrateTable[model.PluginCanvasProjection]("plugin_canvas_projections"),
		migrateTable[model.PluginConnection]("plugin_connections"),
		migrateTable[model.PluginConnectionVersion]("plugin_connection_versions"),
		migrateTable[model.PluginConnectionRate]("plugin_connection_rates"),
		migrateTable[model.PluginOperationPrice]("plugin_operation_prices"),
		migrateTable[model.PluginRemoteExecution]("plugin_remote_executions"),
		migrateTable[model.PluginRunResource]("plugin_run_resources"),
		migrateTable[model.PluginPipelineExecution]("plugin_pipeline_executions"),
		migrateTable[model.PluginInputRequest]("plugin_input_requests"),
		migrateTable[model.PluginBatchApproval]("plugin_batch_approvals"),
		migrateTable[model.PluginExecutionSlot]("plugin_execution_slots"),
		migrateTable[model.PluginBatchMetric]("plugin_batch_metrics"),
