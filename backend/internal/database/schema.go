...
func Models() []any {
	return []any{
		&model.BusinessObject{}, &model.BusinessObjectVersion{},
		...
		&model.PluginRelease{},
		&model.PluginSkillBinding{},
		&model.PluginCatalogLock{},
		&model.PluginReleaseDependency{},
		&model.PluginNamespace{},
		&model.PluginRun{},
		&model.PluginRunStep{},
		...
		&model.PluginBatchApproval{},
		&model.PluginExecutionSlot{},
		&model.PluginBatchMetric{},
