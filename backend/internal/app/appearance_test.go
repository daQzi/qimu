...
func TestUpdateAppearanceClearsMissingCurrentAppearanceResources(t *testing.T) {
	...
	if updated.SkinID != defaultAppearanceSkinID || updated.LogoResourceID != "" || updated.DarkLogoResourceID != "" || updated.AuthVideoResourceID != "" || updated.AuthVideoPosterResourceID != "" {
